...
public class JiraServiceTuke {
    ...
    @Autowired
    public JiraServiceTuke(@Value("${spring.security.oauth2.client.registration.jira.client-id.tuke}") String clientId,
                       @Value("${spring.security.oauth2.client.registration.jira.client-secret.tuke}") String clientSecret,
