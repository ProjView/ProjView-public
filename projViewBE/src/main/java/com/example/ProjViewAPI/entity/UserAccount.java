 ...
 */
@Entity
public abstract class UserAccount implements UserDetails, CredentialsContainer {
...
//    }
    ...
    public static UserBuilder withDefaultPasswordEncoder() {
        logger.warn("UserAccount.withDefaultPasswordEncoder() is considered unsafe for production "
